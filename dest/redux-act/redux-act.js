...
/***/ function(module, exports, __webpack_require__) {
	...
	var add = (0, _reduxAct.createAction)('add some duff');
	var increment = (0, _reduxAct.createAction)('增加 increment');
	var decrement = (0, _reduxAct.createAction)('减小 decrement');

	var counterReducer = (0, _reduxAct.createReducer)((_createReducer = {}, _defineProperty(_createReducer, increment, function (state) {
	  return state + 1;
	}), _defineProperty(_createReducer, decrement, function (state) {
	  return state - 1;
	}), _defineProperty(_createReducer, add, function (state, payload) {
	  return state + payload;
	}), _createReducer), 0);

	var counterStore = (0, _redux.createStore)(counterReducer);
